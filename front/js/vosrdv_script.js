...
function addImage(json){
    ...
    switch(json){
        case 'House':
            source="../pictures/doctor-avatar-1.jpeg";
            break;
        case 'Greys':
            source="../pictures/doctor-avatar-1.jpeg";
            break;
        case 'Mabhoul':
            source="../pictures/doctor-avatar-2.jpeg";
            break;
        case 'Norbert':
            source="../pictures/doctor-avatar-3.png";
            break;
    }
...
function recuperationBDDrdvPatient(){
    ...
    xhr2.open("GET","../../back/affichageRdv.php",false)
    xhr2.send();
}
...
function annulationRDV(id_rdv){
    ...
    xhr2.open("POST","../../back/annuleRDV.php",false);
